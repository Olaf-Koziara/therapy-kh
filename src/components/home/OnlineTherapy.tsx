      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-earth-brown-900 mb-8">Psychoterapia On-line</h2>
            <p className="text-lg text-earth-brown-700 leading-relaxed mb-8">
              Współczesna terapia nie zna granic. Jeśli mieszkasz poza Gdańskiem, często podróżujesz lub po prostu preferujesz komfort własnego domu, zapraszam na sesje on-line.
            </p>

            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <Globe className="text-earth-sage-600 mt-1 flex-shrink-0" size={24} />
                <div>
                  <h4 className="text-lg font-bold text-earth-brown-800">Dostępność</h4>
                  <p className="text-earth-brown-600">Możliwość podjęcia terapii z dowolnego miejsca na świecie.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <ShieldCheck className="text-earth-sage-600 mt-1 flex-shrink-0" size={24} />
                <div>
                  <h4 className="text-lg font-bold text-earth-brown-800">Dyskrecja i Bezpieczeństwo</h4>
                  <p className="text-earth-brown-600">Korzystam z bezpiecznych i szyfrowanych połączeń, dbając o pełną poufność sesji.</p>
                </div>
              </div>
            </div>
          </motion.div>
