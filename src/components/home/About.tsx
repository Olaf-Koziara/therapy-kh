      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-7/12 order-1">
            <span className="text-earth-sage-600 font-bold tracking-widest uppercase text-xs sm:text-sm mb-3 block">
              O mnie i Kwalifikacje
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-earth-brown-900 leading-tight">
              Spotkanie, relacja, doświadczenie
            </h2>
            
            <p className="text-base sm:text-lg text-earth-brown-700 leading-relaxed mb-5">
            ...
            <p className="text-base sm:text-lg text-earth-brown-700 leading-relaxed mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {credentials.map((item, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-3 bg-earth-sage-50/60 p-3.5 rounded-xl border border-earth-sage-200/80 hover:bg-earth-sage-100 transition-colors"
                >
                  <div className="mt-0.5 bg-earth-sage-600 text-earth-beige-50 p-1.5 rounded-lg shrink-0">
                    <item.icon size={16} />
                  </div>
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 text-earth-sage-600 font-bold hover:text-earth-sage-700 transition-all py-3.5 px-6 rounded-2xl border-2 border-earth-sage-200 bg-earth-sage-50/50 hover:bg-earth-sage-100 shadow-sm text-sm sm:text-base"
              ...
              >
                ...
                {showFullQualifications ? <ChevronUp size={20} className="text-earth-sage-600" /> : <ChevronDown size={20} className="text-earth-sage-600" />}
              </button>
            </div>

            {/* Detailed Qualifications - Placed DIRECTLY below the button */}
            {showFullQualifications && (
              <div className="mt-6 mb-8 p-6 sm:p-8 bg-earth-beige-50 rounded-3xl border border-earth-beige-200 transition-all animate-fadeIn">
                <h3 className="text-xl sm:text-2xl font-bold text-earth-brown-900 mb-6 flex items-center gap-3 border-b border-earth-beige-200 pb-4">
                  <GraduationCap className="text-earth-sage-600 shrink-0" size={26} />
                  <span>Szczegółowe wykształcenie i dorobek zawodowy</span>
                </h3>

                <div className="space-y-8">
                  <div>
                    <h4 className="text-base sm:text-lg font-bold text-earth-brown-900 mb-3 flex items-center gap-2">
                      <BookOpen className="text-earth-sage-600 shrink-0" size={18} />
                      Wykształcenie i Szkoły Psychoterapii
                    </h4>
                    <ul className="space-y-3 text-earth-brown-700 text-sm leading-relaxed pl-1">
                      <li className="flex items-start gap-2.5">
                        <span className="text-earth-sage-600 font-bold mt-0.5">•</span>
                  ...
                  <div>
                    <h4 className="text-base sm:text-lg font-bold text-earth-brown-900 mb-3 flex items-center gap-2 border-t border-earth-beige-200 pt-6">
                      <Briefcase className="text-earth-sage-600 shrink-0" size={18} />
            ...
            <div className="pt-2">
              <Link
                href="/kontakt"
                className="inline-flex items-center space-x-2 bg-earth-sage-600 hover:bg-earth-sage-700 text-earth-beige-50 font-bold text-base py-3.5 px-7 rounded-2xl shadow-md hover:shadow-lg transition-all"
              >
          ...
          <div className="w-full lg:w-5/12 order-2 mt-4 lg:mt-0">
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-4 sm:space-y-6 pt-6 sm:pt-10">
                <div className="aspect-square bg-earth-sage-50 rounded-3xl overflow-hidden flex items-center justify-center p-6 border border-earth-sage-100 group shadow-sm">
                   <Image
                ...
                <div className="aspect-[3/4] bg-earth-brown-900 rounded-3xl shadow-md flex flex-col items-center justify-center p-6 text-earth-beige-50 text-center">
                  <Heart className="text-earth-sage-400 mb-3" size={40} />
                  <p className="text-xs sm:text-sm font-medium text-earth-brown-200">Empatia i autentyczny kontakt</p>
                </div>
              </div>

              <div className="space-y-4 sm:space-y-6">
                <div className="aspect-[3/4] bg-gradient-to-br from-earth-sage-600 to-earth-sage-800 rounded-3xl shadow-md flex flex-col items-center justify-center p-6 text-earth-beige-50 text-center">
                   <Target className="text-earth-sage-200 mb-3" size={40} />
                   <p className="text-xs sm:text-sm font-medium text-earth-sage-100">Świadomość własnych potrzeb</p>
                </div>
                <div className="aspect-square bg-earth-sage-100/70 rounded-3xl shadow-sm border border-earth-sage-200 flex flex-col items-center justify-center p-6 text-center">
                   <BookOpen className="text-earth-sage-700 mb-2" size={36} />
                   <p className="text-xs font-semibold text-earth-brown-800">Doświadczenie od 2009 r.</p>
                </div>
              </div>
            </div>

            {/* Trust highlights card below images */}
            <div className="mt-6 grid gap-4 rounded-3xl border border-earth-sage-100 bg-earth-sage-50/60 p-6 sm:grid-cols-2 shadow-sm">
              <div className="flex items-start gap-3">
                <ShieldCheck className="mt-0.5 shrink-0 text-earth-sage-600" size={20} />
                <p className="text-xs sm:text-sm leading-relaxed text-earth-brown-700">
                  Praca w poufnej relacji, regularna superwizja u certyfikowanych superwizorów.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="mt-0.5 shrink-0 text-earth-sage-600" size={20} />
                <p className="text-xs sm:text-sm leading-relaxed text-earth-brown-700">
