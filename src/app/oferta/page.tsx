    ...
    <main className="pt-24">
      ...
      <section className="bg-white py-20 px-6">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold text-earth-brown-900 md:text-4xl">
            ...
            {landingPages.map((page) => {
              ...
              return (
                <Link
                  key={page.slug}
                  href={`/${page.slug}`}
                  className="group flex flex-col rounded-3xl border border-earth-beige-200 bg-earth-beige-50/60 p-8 transition-all hover:border-earth-sage-300 hover:bg-earth-sage-50/40 hover:shadow-md"
                >
                  <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-earth-sage-100 text-earth-sage-600 transition-colors group-hover:bg-earth-sage-600 group-hover:text-earth-beige-50">
                    <Icon size={24} />
                  </div>
                  <h3 className="mb-3 text-xl font-bold text-earth-brown-900">
                    {page.title}
                  </h3>
                  <p className="mb-6 flex-1 text-earth-brown-700 leading-relaxed">
                    {page.description}
                  </p>
                  <span className="inline-flex items-center gap-2 text-sm font-bold text-earth-sage-600">
                    Dowiedz się więcej
                    <ArrowRight
                      size={16}
      ...
      <section className="bg-earth-beige-50 py-20 px-6">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-8 text-center text-3xl font-bold text-earth-brown-900">
            Informacje organizacyjne
          </h2>
          <ul className="mb-10 space-y-5 rounded-3xl border border-earth-beige-200 bg-white p-8 sm:p-10">
